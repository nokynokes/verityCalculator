...
shapesMissing insideShape outsideShape = 
    case (insideShape, outsideShape) of
        (Square, Prism) -> Just [Circle]
        (Square, Cylinder) -> Just [Triangle]
        (Square, Cube) -> Just [Triangle, Circle]
        (Square, Sphere) -> Just [Triangle]
        (Square, Pyramid) -> Just [Circle]
        (Triangle, Prism) -> Just [Circle]
        (Triangle, Cone) -> Just [Square]
        (Triangle, Cube) -> Just [Circle]
        (Triangle, Sphere) -> Just [Square]
        (Triangle, Pyramid) -> Just [Circle, Square]
        (Circle, Cylinder) -> Just [Triangle]
        (Circle, Cone) -> Just [Square]
        (Circle, Cube) -> Just [Triangle]
        (Circle, Sphere) -> Just [Square, Triangle]
        (Circle, Pyramid) -> Just [Square]
        _ -> Nothing
